 ...
 */
void
MD5Update(MD5_CTX *context, const void *inpp, size_t Len)
{
    uint32_t i, index, partLen;
    const unsigned char *input = (const unsigned char *)inpp;
        unsigned int inputLen = (unsigned int) Len;
 ...
 */
void
MD5Final(void *result, MD5_CTX *context)
{
    unsigned char *digest = (unsigned char *) result;
